...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/cool-union-908e
```

A live public deployment of this template is available at [https://cool-union-908e.templates.workers.dev](https://cool-union-908e.templates.workers.dev)
